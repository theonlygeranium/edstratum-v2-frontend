...
- Voice input cannot be enabled safely until `public/_headers` is updated for the intended microphone permission policy; it currently sets `microphone=()`.
